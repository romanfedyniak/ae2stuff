...
public final class BlockAdvancedInscriber extends AEBaseTileBlock {
    ...
    public IBlockState getActualState(final IBlockState state, final IBlockAccess world, final BlockPos pos) {
        final TileAdvancedInscriber inscriber = this.getTileEntity(world, pos);
        return super.getActualState(state, world, pos).withProperty(ACTIVE, inscriber != null && inscriber.isWorking());
    }
    ...
    public boolean onActivated(final World world, final BlockPos pos, final EntityPlayer player, final EnumHand hand,
        ...
        if (Platform.isServer() && this.getTileEntity(world, pos) != null) {
            player.openGui(AE2Stuff.instance, ModGuiHandler.ADVANCED_INSCRIBER, world, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
}
